...
class _PotionSelectionSheetState extends State<PotionSelectionSheet> {
      ...
      children: [
        ...
        FutureBuilder<List<ProductItem>>(
          ...
          builder: (context, snap) {
            ...
            if (snap.hasError) {
              return _buildErrorBox('Error carregant pocions');
            }

            final potions = snap.data ?? [];
            if (potions.isEmpty) return _buildEmptyState(context);
  ...
  Widget _buildPotionTile(ProductItem potion, AppLocalizations t) {
    final isSelected = _selectedPotion?.productName == potion.productName;
              ...
              Column(
                ...
                children: [
                  ...
                  Icon(
                    ...
                    size: 14,
                    color: isSelected ? potionYellow : Colors.white54,
                  ),
                ],
              ),
            ],
